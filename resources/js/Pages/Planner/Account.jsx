...
const Account = () => {
        ...
        const fetchUser = async () => {
            try {
                ...
                if (response.ok) {
                    ...
                    setPlannerData({
                        name: userData.planner?.name || "",
                        bio: userData.planner?.bio || "",
                    });
                } else {
                    router.visit("/unauthorized");
                }
    ...
    const handleChangePlanner = (e) => {
        const { name, value } = e.target;
        setPlannerData((prev) => ({ ...prev, [name]: value }));
    };
    ...
    const handleSubmitPlanner = async (e) => {
        ...
        try {
            const response = await fetch(
                "http://127.0.0.1:8000/api/update-planner-info",
                {
                    method: "PUT",
                    headers: {
                        "Content-Type": "application/json",
    ...
    return (
        <Layout user={user}>
            ...
            <div className="max-w-2xl mx-auto p-6 bg-gray-200/10 shadow rounded-lg mt-10">
                <h1 className="text-2xl font-bold mb-6">Planner Information</h1>
